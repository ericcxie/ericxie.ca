...
export default function Footer() {
  return (
    <footer className="inset-x-0 mt-auto border-t border-zinc-500 bg-background-light py-3 text-text-light-body dark:bg-background-dark dark:text-text-dark-body">
