  ...
  ({ className, children, ...props }, forwardedRef) => {
    ...
    return (
      ...
      <div
        ...
        aria-label="dropzone"
        className={cn(
          "flex items-center justify-center rounded-md border border-oklch(0.922 0 0) bg-oklch(1 0 0) px-4 py-2 ring-offset-oklch(1 0 0) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-oklch(0.708 0 0) focus-visible:ring-offset-2 dark:border-oklch(1 0 0 / 10%) dark:border-oklch(1 0 0 / 15%) dark:bg-oklch(0.145 0 0) dark:ring-offset-oklch(0.145 0 0) dark:focus-visible:ring-oklch(0.556 0 0)",
          context.isDragActive && "animate-pulse bg-black/5",
          context.isInvalid && "border-oklch(0.577 0.245 27.325) dark:border-oklch(0.704 0.191 22.216)",
          className,
        )}
      >
        {children}
...
>((props, ref) => {
  ...
  return (
    <p
      ...
      {...rest}
      className={cn("pb-1 text-sm text-oklch(0.556 0 0) dark:text-oklch(0.708 0 0)", className)}
    />
  );
});
  ...
  return (
    ...
    >
      <li
        ...
        className={cn(
          "flex flex-col justify-center gap-2 rounded-md bg-oklch(0.97 0 0)/40 px-4 py-2 dark:bg-oklch(0.269 0 0)/40",
          className,
        )}
      >
        {props.children}
...
>((props, ref) => {
  ...
  return (
    <p
      ...
      {...rest}
      className={cn(
        "h-5 text-[0.8rem] font-medium text-oklch(0.577 0.245 27.325) dark:text-oklch(0.704 0.191 22.216)",
        rest.className,
      )}
    >
      {body}
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <label
        ...
        {...props}
        className={cn(
          "cursor-pointer rounded-sm bg-oklch(0.97 0 0) px-4 py-2 font-medium ring-offset-oklch(1 0 0) transition-colors focus-within:outline-none hover:bg-oklch(0.97 0 0)/80 has-[input:focus-visible]:ring-2 has-[input:focus-visible]:ring-oklch(0.708 0 0) has-[input:focus-visible]:ring-offset-2 dark:bg-oklch(0.269 0 0) dark:ring-offset-oklch(0.145 0 0) dark:hover:bg-oklch(0.269 0 0)/80 dark:has-[input:focus-visible]:ring-oklch(0.556 0 0)",
          className,
        )}
      >
        {children}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        {...props}
        className={cn(
          "relative h-2 w-full overflow-hidden rounded-full bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)",
          className,
        )}
      >
        <div
          ...
          className={cn(
            "h-full w-full rounded-full bg-oklch(0.205 0 0) dark:bg-oklch(0.922 0 0)",
            done ? "translate-x-0" : "animate-infinite-progress",
            error && "bg-oklch(0.577 0.245 27.325) dark:bg-oklch(0.704 0.191 22.216)",
          )}
        />
      </div>
    );
